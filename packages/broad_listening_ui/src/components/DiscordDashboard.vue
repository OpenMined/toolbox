    ...
    <div class="p-6 space-y-6">
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <dd class="text-lg font-semibold text-gray-900">
                {{ connectionsStore.dashboardData.discord.totalMessages }}
              </dd>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <dd class="text-lg font-semibold text-gray-900">
                {{ connectionsStore.dashboardData.discord.latestActivity }}
              </dd>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white rounded-lg border border-gray-200">
        ...
        <div class="p-6">
          <div class="space-y-4">
            <div
              v-for="(count, model) in connectionsStore.dashboardData.discord
                .embeddingCounts"
              :key="model"
