...
import pytest
from discord_mcp.db import get_discord_connection, upsert_guild, upsert_channel, upsert_user, upsert_message
from discord_mcp.models import DiscordGuild, DiscordChannel, DiscordUser, DiscordMessage
...
class TestMCPServer:
    ...
    def _populate_test_data(self, conn):
        ...
        for i in range(5):
            user = DiscordUser(
                ...
                discriminator="0001" if i < 4 else None,  # Newer users might not have discriminator
    ...
    def test_get_channels(self):
        ...
        with get_discord_connection(self.test_db_path) as conn:
            ...
            mcp_module.db.get_discord_connection = lambda: get_discord_connection(self.test_db_path)
